#ifndef IAF_PSC_DELTA_GPU_H
#define IAF_PSC_DELTA_GPU_H
...
namespace nest
{
  ...
  class iaf_psc_delta_gpu : public model_gpu
  {
  public:
...
cl::Buffer S__refr_spikes_buffer_;
cl::Buffer V__RefractoryCounts_;
cl::Buffer S__y3_;
cl::Buffer V__P33_;
cl::Buffer P__with_refr_input_;
...
double* h_S__refr_spikes_buffer_;
int* h_V__RefractoryCounts_;
double* h_S__y3_;
double* h_V__P33_;
bool* h_P__with_refr_input_;
