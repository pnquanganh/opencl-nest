#ifndef HH_PSC_ALPHA_GPU_H
#define HH_PSC_ALPHA_GPU_H
...
namespace nest
{
  ...
  class hh_psc_alpha_gpu : public model_gpu
  {
  public:
...
cl::Buffer P__g_K;
cl::Buffer P__g_L;
cl::Buffer V__PSCurrInit_I_;
cl::Buffer S__r_;
cl::Buffer V__PSCurrInit_E_;
cl::Buffer P__E_L;
cl::Buffer P__E_K;
cl::Buffer S__y_;
cl::Buffer P__I_e;
...
double* h_P__g_K;
double* h_P__g_L;
double* h_V__PSCurrInit_I_;
int* h_S__r_;
double* h_V__PSCurrInit_E_;
double* h_P__E_L;
double* h_P__E_K;
double* h_S__y_;
double* h_P__I_e;
