#ifndef GIF_COND_EXP_GPU_H
#define GIF_COND_EXP_GPU_H
...
namespace nest
{
  ...
  class gif_cond_exp_gpu : public model_gpu
  {
  public:
...
cl::Buffer P__g_L_;
cl::Buffer P__E_in_;
cl::Buffer P__tau_synE_;
cl::Buffer S__sfa_;
cl::Buffer P__E_L_;
cl::Buffer P__I_e_;
cl::Buffer S__stc_;
cl::Buffer P__c_m_;
cl::Buffer S__I_stim_;
cl::Buffer P__E_ex_;
cl::Buffer P__tau_synI_;
