#ifndef AEIF_COND_ALPHA_GPU_H
#define AEIF_COND_ALPHA_GPU_H
...
namespace nest
{
  ...
  class aeif_cond_alpha_gpu : public model_gpu
  {
  public:
...
cl::Buffer S__r_;
cl::Buffer V__refractory_counts_;
cl::Buffer P__E_in;
cl::Buffer P__C_m;
cl::Buffer P__V_peak_;
cl::Buffer P__g_L;
cl::Buffer P__Delta_T;
cl::Buffer P__V_th;
cl::Buffer P__b;
cl::Buffer V__g0_in_;
cl::Buffer P__tau_syn_ex;
cl::Buffer P__E_ex;
cl::Buffer B__step_;
...
double* h_P__a;
double* h_B__I_stim_;
double* h_P__tau_syn_in;
double* h_P__E_L;
double* h_S__y_;
double* h_P__I_e;
double* h_V__V_peak;
double* h_B__IntegrationStep_;
unsigned int* h_S__r_;
unsigned int* h_V__refractory_counts_;
double* h_P__E_in;
double* h_P__C_m;
double* h_P__V_peak_;
double* h_P__g_L;
