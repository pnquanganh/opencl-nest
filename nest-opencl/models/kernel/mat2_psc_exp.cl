...
__global double *V__P11th_,
__global double *S__V_th_2_,
__global double *S__V_th_1_,
__global double *V__P22_expm1_,
__global int *S__r_,
		  ...
		  __global unsigned int *spike_count)
{
...

  {
    ...
    S__V_m_[tid] = S__V_m_[tid] * V__P22_expm1_[tid] + S__V_m_[tid] + S__i_syn_ex_[tid] * V__P21ex_[tid]
      + S__i_syn_in_[tid] * V__P21in_[tid] + ( P__I_e_[tid] + S__i_0_[tid] ) * V__P20_[tid];

    // evolve adaptive threshold
    S__V_th_1_[tid] *= V__P11th_[tid];
    S__V_th_2_[tid] *= V__P22th_[tid];
    ...
    {
      if ( S__V_m_[tid] >= P__omega_[tid] + S__V_th_2_[tid]
          + S__V_th_1_[tid] ) // threshold crossing
      {
