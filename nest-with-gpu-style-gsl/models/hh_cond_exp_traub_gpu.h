#ifndef HH_COND_EXP_TRAUB_GPU_H
#define HH_COND_EXP_TRAUB_GPU_H
...
namespace nest
{
  ...
  class hh_cond_exp_traub_gpu : public model_gpu
  {
  public:

    hh_cond_exp_traub_gpu();
    ~hh_cond_exp_traub_gpu();
