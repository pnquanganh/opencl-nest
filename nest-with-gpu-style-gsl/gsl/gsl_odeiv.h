...
std_control_state_t * gsl_odeiv_control_standard_new(double eps_abs, double eps_rel, double a_y, double a_dydt);
std_control_state_t * gsl_odeiv_control_y_new(double eps_abs, double eps_rel);
std_control_state_t * gsl_odeiv_control_yp_new(double eps_abs, double eps_rel);
...
int gsl_odeiv_evolve_apply(gsl_odeiv_evolve * e, std_control_state_t * con_state, rkf45_state_t * step, int dim, const gsl_odeiv_system * dydt, double * t, double t1, double * h, double y[]);
int gsl_odeiv_evolve_reset(gsl_odeiv_evolve * e);
void gsl_odeiv_evolve_free(gsl_odeiv_evolve * e);

rkf45_state_t * rkf45_alloc (size_t dim);
int rkf45_reset (void *vstate, size_t dim);
unsigned int rkf45_order ();
int rkf45_apply (void *vstate, size_t dim, double t, double h, double y[], double yerr[], const double dydt_in[], double dydt_out[], const gsl_odeiv_system * sys);
