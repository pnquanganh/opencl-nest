#ifndef IAF_COND_EXP_SFA_RR_GPU_H
#define IAF_COND_EXP_SFA_RR_GPU_H
...
namespace nest
{
  ...
  class iaf_cond_exp_sfa_rr_gpu : public model_gpu
  {
  public:

    iaf_cond_exp_sfa_rr_gpu();
    ~iaf_cond_exp_sfa_rr_gpu();
...
#endif // IAF_COND_EXP_SFA_RR_GPU_H
