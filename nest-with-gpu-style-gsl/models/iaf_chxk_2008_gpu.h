#ifndef IAF_CHXK_2008_GPU_H
#define IAF_CHXK_2008_GPU_H
...
namespace nest
{
  ...
  class iaf_chxk_2008_gpu : public model_gpu
  {
  public:
...
cl::Buffer V__PSConInit_AHP;
cl::Buffer P__ahp_bug;
cl::Buffer V__PSConInit_E;
cl::Buffer P__V_th;
cl::Buffer V__PSConInit_I;
cl::Buffer P__E_L;
cl::Buffer P__I_e;
cl::Buffer P__g_L;
...
double* h_V__PSConInit_AHP;
bool* h_P__ahp_bug;
double* h_V__PSConInit_E;
double* h_P__V_th;
double* h_V__PSConInit_I;
double* h_P__E_L;
double* h_P__I_e;
double* h_P__g_L;
