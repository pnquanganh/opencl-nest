  ...
  std::deque< histentry >::iterator* finish )
{
  *finish = history_.end();
  ...
  std::deque< histentry >&
  nest::Archiving_Node::get_all_history()
  {
    return this->history_;
  }

  double
  nest::Archiving_Node::get_Kminus_()
  {
    return Kminus_;
  }

  double
  nest::Archiving_Node::get_triplet_Kminus_()
  {
    return triplet_Kminus_;
  }

  double
  nest::Archiving_Node::get_tau_minus_inv_()
  {
    return tau_minus_inv_;
  }

  double
  nest::Archiving_Node::get_tau_minus_triplet_inv_()
  {
    return tau_minus_triplet_inv_;
  }
